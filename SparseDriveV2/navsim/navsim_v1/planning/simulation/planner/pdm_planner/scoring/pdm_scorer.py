...
from navsim.navsim_v1.planning.simulation.planner.pdm_planner.scoring.pdm_comfort_metrics import ego_is_comfortable
from navsim.navsim_v1.planning.simulation.planner.pdm_planner.scoring.pdm_scorer_utils import get_collision_type
from navsim.navsim_v1.planning.simulation.planner.pdm_planner.utils.pdm_path import PDMPath
from navsim.navsim_v1.planning.simulation.planner.pdm_planner.utils.pdm_array_representation import (
    coords_array_to_polygon_array,
    state_array_to_coords_array,
)
from navsim.navsim_v1.planning.simulation.planner.pdm_planner.utils.pdm_enums import (
    BBCoordsIndex,
    EgoAreaIndex,
    MultiMetricIndex,
    StateIndex,
...
class PDMScorer:
    ...
    def _aggregate_scores(self) -> npt.NDArray[np.float64]:
        ...
        if self.train_mode:
            ...
            normalized_progress = np.ones_like(raw_progress)
            normalized_progress[bigger_than_t_mask] = raw_progress[bigger_than_t_mask] / max_raw_progress[
                bigger_than_t_mask]
        else:
    ...
    def _reset(
        ...
        self.oncoming_progress_over_horizon = None
    ...
    def _calculate_driving_direction_compliance(self) -> None:
        ...
        self.oncoming_progress_over_horizon = oncoming_progress_over_horizon
